...
<br>
<h1>Please type in SubjectID and SubjectName you would like to add.</h1>
<h2>In order to register subject to a class, please to go to "Add Classes & Show Individual Tables".</h2>
<form method="post" action="addsubject">
Subjectid:<br>
<input type="text" name="Subjectidtoadd">
<br>
Subjectname:<br>
<input type="text" name="Subjectnametoadd">
<br>
<input type="submit" value="addSubject">
<br>
</form>

<h1 >Please type in Subjectid to delete.</h1>

<form method="post" action="deletesubject">
Subjectid:<br>
<input type="text" name="Subjectidtodelete">
<br>
<input type="submit" value="deleteSubject">
</form>
