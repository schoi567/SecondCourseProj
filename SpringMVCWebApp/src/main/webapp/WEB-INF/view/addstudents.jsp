...
<br>
<h1>Please type in Studentid and Studentname you would like to add.</h1>
<h2>In order to register student to a class, please to go to "Add Classes & Show Individual Tables".</h2>
<form method="post" action="addstudent">
Studentid:<br>
<input type="text" name="Studentidtoadd">
<br>
Studentname:<br>
<input type="text" name="Studentnametoadd">
<br>
<input type="submit" value="addStudent">
<br>
</form>

<h1 >Please type in Studentid to delete.</h1>

<form method="post" action="deletestudent">
Studentid:<br>
<input type="text" name="Studentidtodelete">
<br>
